...
```{r echo=FALSE}
step_bd <- step(M1.pp.fit.fm, direction = "both")
...
```{r echo=FALSE}
step_bd <- step(M2.fit.fm, direction = "both")
step_bd # Display elimination results
...
```{r echo=FALSE}
step_bd <- step(M3.fit.fm, direction = "both")
step_bd # Display elimination results
...
```{r echo=FALSE}
step_bd <- step(M4.fit.fm, direction = "both")
step_bd # Display elimination results
FM = get_model(step_bd) # Display the final model
```
